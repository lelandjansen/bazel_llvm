...
# Generated targets for binaries. See ./scripts/make_filegroups.sh
...
filegroup(
    name = "clangd-xpc-test-client",
    srcs = ["bin/clangd-xpc-test-client"],
)
...
filegroup(
    name = "mlir-tblgen",
    srcs = ["bin/mlir-tblgen"],
)

filegroup(
    name = "mlir-translate",
    srcs = ["bin/mlir-translate"],
)
